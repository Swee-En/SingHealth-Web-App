...
import { UploadPhotos1, UploadPhotos2, UploadPhotos3, UploadPhotos5 } from "../../frontendUtils/UploadPhoto";
      ...
      <View style={styles.finalPageView}>
        ...
        <View style={{ marginTop: 200, marginBottom: 35 }}>
          ...
          <View style={styles.summaryBox}>
            ...
            <Text style={styles.critText}>{(((this.state.crit1_score / this.state.total_crit1_score) * 10) + ((this.state.crit2_score / this.state.total_crit2_score) * 20) + ((this.state.crit3_score / this.state.total_crit3_score) * 35) + ((this.state.crit5_score / this.state.total_crit5_score) * 20)).toFixed(2)}/100%</Text>
          </View>
