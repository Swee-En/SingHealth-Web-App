...
import { UploadPhotos11, UploadPhotos12, UploadPhotos13 } from "./UploadPhoto"
        ...
        <View style={styles.finalPageView}>
          ...
          <View style={{ marginTop: 200, marginBottom: 35 }}>
            ...
            <View style={styles.summaryBox}>
              ...
              <Text style={styles.critText}>{(((this.state.crit1_score + this.state.crit2_score + this.state.crit3_score) / (this.state.total_crit1_score + this.state.total_crit2_score + this.state.total_crit3_score)) * 100).toFixed(2)}/100%</Text>
            </View>
